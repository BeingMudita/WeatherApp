...
win = Tk()
win.title("Mudita Jain ")
win.config(bg ="light blue")
win.geometry("570x570")

name_label=  Label(win, text="Weather App", font=("Segoe Script", 40))
name_label.place(x=25, y= 50, height=50, width=450)

city_name= StringVar()
list_name =["Andhra Pradesh","Arunachal Pradesh ","Assam","Bihar","Chhattisgarh","Goa","Gujarat","Haryana","Himachal Pradesh","Jammu and Kashmir","Jharkhand","Karnataka","Kerala","Madhya Pradesh","Maharashtra","Manipur","Meghalaya","Mizoram","Nagaland","Odisha","Punjab","Rajasthan","Sikkim","Tamil Nadu","Telangana","Tripura","Uttar Pradesh","Uttarakhand","West Bengal","Andaman and Nicobar Islands","Chandigarh","Dadra and Nagar Haveli","Daman and Diu","Lakshadweep","National Capital Territory of Delhi","Puducherry"]
com= ttk.Combobox(win, text="Weather App",values= list_name,  font=("Time New Roman", 20),textvariable=city_name)
com.place(x=25, y= 120, height=50, width=450)


w_label=  Label(win, text="Climate:", font=("Time New Roman", 20))
...
wb_label=  Label(win, text="Description:", font=("Time New Roman", 17))
...
done_button= Button(win, text="Submit",  font=("Time New Roman", 20), command= data_get)
